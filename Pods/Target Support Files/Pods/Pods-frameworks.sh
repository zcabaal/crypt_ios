...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/Braintree.framework"
  ...
  install_framework "Pods/JWTDecode.framework"
  install_framework "Pods/LUKeychainAccess.framework"
  install_framework "Pods/Lock.framework"
  install_framework "Pods/LockFacebook.framework"
  install_framework "Pods/MBProgressHUD.framework"
  install_framework "Pods/Masonry.framework"
  install_framework "Pods/NSData_Base64.framework"
  ...
  install_framework "Pods/SimpleKeychain.framework"
