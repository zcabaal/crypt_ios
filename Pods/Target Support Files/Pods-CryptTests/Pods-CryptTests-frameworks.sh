...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-CryptTests/BDBOAuth1Manager.framework"
  ...
  install_framework "Pods-CryptTests/ISO8601DateFormatter.framework"
  ...
  install_framework "Pods-CryptTests/LockTwitter.framework"
